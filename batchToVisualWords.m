...
load('E:/hw1/release/data/traintest.mat','all_imagenames','mapping');
load('E:/hw1/release/data/dictionary.mat','filterBank','dictionary');

source = 'E:/hw1/release/data/';
target = 'E:/hw1/release/data/'; 
